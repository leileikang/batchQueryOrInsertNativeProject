 ...
 * @date 2019/8/30
 */
@ApiModel(value = "BatchStatisticsInfoEntity", description = "访问信息明细库")
@Table(name = "t_statistics_info")
@QueryEntity
@Data
@Entity
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class BatchStatisticsInfoEntity {
    ...
    @GenericGenerator(name = "guuidGenerator",
            strategy = "com.ceis.core.base.persistence.GUUIDGenerator")
